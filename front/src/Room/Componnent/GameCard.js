...
const GameCard = ({ card, hidden = false, cardBackside, index, draggable = true, handleCardClick, offsetX = 0, rotation = 0, selectedCard, src, cardName, opponent = true, offsetY = 0, setHoveredCard }) => {

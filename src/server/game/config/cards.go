...
type Effect struct {
	...
	TurnUsageLimit        map[string]int `json:"turn_usage_limit"`
	GameUsageLimit        map[string]int `json:"game_usage_limit"`
	TurnActivationLimit   map[string]int `json:"turn_activation_limit"`
	GameActivationLimit   map[string]int `json:"game_activation_limit"`
}
